...
// 2022-08-31 19:22:00.388489200 UTC
	...
	namespace signatures {
		...
		constexpr auto dwForceAttack2 = 0x320DE48;
		constexpr auto dwForceBackward = 0x320DDE8;
		constexpr auto dwForceForward = 0x320DE6C;
		constexpr auto dwForceJump = 0x52878FC;
		constexpr auto dwForceLeft = 0x320DDF4;
		constexpr auto dwForceRight = 0x320DE00;
		constexpr auto dwGameDir = 0x62B900;
		constexpr auto dwGameRulesProxy = 0x52FB12C;
		constexpr auto dwGetAllClasses = 0xDEBCAC;
		constexpr auto dwGlobalVars = 0x58CCE0;
		constexpr auto dwGlowObjectManager = 0x53265D0;
		constexpr auto dwInput = 0x522EEF0;
		constexpr auto dwInterfaceLinkList = 0x970754;
		constexpr auto dwLocalPlayer = 0xDC14CC;
		constexpr auto dwMouseEnable = 0xDC71D8;
		constexpr auto dwMouseEnablePtr = 0xDC71A8;
		constexpr auto dwPlayerResource = 0x320C180;
		constexpr auto dwRadarBase = 0x5212694;
		constexpr auto dwSensitivity = 0xDC7074;
		constexpr auto dwSensitivityPtr = 0xDC7048;
		constexpr auto dwSetClanTag = 0x8A410;
		constexpr auto dwViewMatrix = 0x4DCF234;
		constexpr auto dwWeaponTable = 0x522F9B4;
		constexpr auto dwWeaponTableIndex = 0x326C;
		constexpr auto dwYawPtr = 0xDC6E38;
		constexpr auto dwZoomSensitivityRatioPtr = 0xDCD620;
		constexpr auto dwbSendPackets = 0xD85A2;
		constexpr auto dwppDirect3DDevice9 = 0xA6050;
		constexpr auto find_hud_element = 0x56F55C30;
		constexpr auto force_update_spectator_glow = 0x3BE47A;
		constexpr auto interface_engine_cvar = 0x3EA3C;
		constexpr auto is_c4_owner = 0x3CB4E0;
		...
		constexpr auto m_pitchClassPtr = 0x5212930;
		constexpr auto m_yawClassPtr = 0xDC6E38;
		constexpr auto model_ambient_min = 0x590054;
		constexpr auto set_abs_angles = 0x1E5AB0;
		constexpr auto set_abs_origin = 0x1E58F0;
	} // namespace signatures
	namespace custom {
		float noflash = 0.0f;
		DWORD flash_value;
