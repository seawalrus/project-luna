...
namespace offsets {
	...
	constexpr auto convar_name_hash_table = 0x2F190;
	...
	constexpr auto dwEntityList = 0x4DDB8FC;
	constexpr auto dwForceAttack = 0x320BDC8;
	constexpr auto dwForceAttack2 = 0x320BDD4;
	constexpr auto dwForceBackward = 0x320BE10;
	constexpr auto dwForceForward = 0x320BE04;
	constexpr auto dwForceJump = 0x52858DC;
	constexpr auto dwForceLeft = 0x320BE1C;
	constexpr auto dwForceRight = 0x320BE28;
	constexpr auto dwGameDir = 0x62B900;
	constexpr auto dwGameRulesProxy = 0x52F910C;
	constexpr auto dwGetAllClasses = 0xDE9C9C;
	constexpr auto dwGlobalVars = 0x58CCE0;
	constexpr auto dwGlowObjectManager = 0x53245E8;
	constexpr auto dwInput = 0x522CED0;
	constexpr auto dwInterfaceLinkList = 0x96EF44;
	constexpr auto dwLocalPlayer = 0xDBF4BC;
	constexpr auto dwMouseEnable = 0xDC51C8;
	constexpr auto dwMouseEnablePtr = 0xDC5198;
	constexpr auto dwPlayerResource = 0x320A160;
	constexpr auto dwRadarBase = 0x5210674;
	constexpr auto dwSensitivity = 0xDC5064;
	constexpr auto dwSensitivityPtr = 0xDC5038;
	constexpr auto dwSetClanTag = 0x8A410;
	constexpr auto dwViewMatrix = 0x4DCD214;
	constexpr auto dwWeaponTable = 0x522D994;
	constexpr auto dwWeaponTableIndex = 0x326C;
	constexpr auto dwYawPtr = 0xDC4E28;
	constexpr auto dwZoomSensitivityRatioPtr = 0xDCB610;
	constexpr auto dwbSendPackets = 0xD8452;
	constexpr auto dwppDirect3DDevice9 = 0xA6050;
	constexpr auto find_hud_element = 0x281D5A80;
	constexpr auto force_update_spectator_glow = 0x3BE35A;
	constexpr auto interface_engine_cvar = 0x3EA3C;
	constexpr auto is_c4_owner = 0x3CB3D0;
	...
	constexpr auto m_pitchClassPtr = 0x5210910;
	constexpr auto m_yawClassPtr = 0xDC4E28;
	constexpr auto model_ambient_min = 0x590054;
	constexpr auto set_abs_angles = 0x1E59F0;
	constexpr auto set_abs_origin = 0x1E5830;
